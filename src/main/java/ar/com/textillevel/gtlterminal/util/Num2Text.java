...
public class Num2Text {
    ...
    public static Num2Text instance;

    public static Num2Text getInstance() {
        if (instance == null) {
            instance = new Num2Text();
        }
        return instance;
    }
    ...
    public static void main(String[] args) {
        final Double numero = 15.61d;
        if (Math.floor(numero.doubleValue()) - Math.abs(numero.doubleValue()) == 0) {
            System.out.println(Num2Text.getInstance().convertirLetras(numero.intValue()));
        } else {
            ...
            System.out.println(Num2Text.getInstance().convertirLetras(Integer.parseInt(pe)) + " con "
